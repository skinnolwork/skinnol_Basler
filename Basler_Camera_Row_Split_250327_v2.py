...
class BaslerCamera:
    ...
    def display_camera_feed(self, img_array, row_intensity):
        ...
        if self.use_cm: 
            ...
            ax.plot(x_axis[:fifth], row_intensity[:fifth], color='red', linewidth=1)
            ...
            ax.plot(x_axis, row_intensity, color='blue', linewidth=1)
            ax.set_ylabel("Intensity")
            ax.set_ylim([0, y_max])
            ...
            plt.plot(x_axis[fifth:3*fifth], row_intensity[fifth:3*fifth], color='red', linewidth=1)
            ax.set_ylabel("Intensity")
            ax.set_ylim([0, y_max])
            ax.xaxis.set_major_locator(MultipleLocator(20))
            ax.tick_params(axis='x', labelsize=8)  # 글씨 크기를 8pt로 줄임
            ...
            plt.plot(x_axis[3*fifth:], row_intensity[3*fifth:], color='red', linewidth=1)
            ax.set_ylabel("Intensity")
            ax.set_ylim([0, y_max])
            ...
            plt.plot(x_axis, row_intensity, color='red', linewidth=1)

...
from scipy.signal import savgol_filter  # 꼭 추가하세요
import cv2
import numpy as np
import matplotlib.pyplot as plt

image_path = "original_Mono12_20250724_140447.tiff"
...
def mouse_callback(event, x, y, flags, param):
    ...
    if event == cv2.EVENT_LBUTTONDOWN:
        ...
        if len(selected_rows) == 2:
            ...
            plt.plot(x_original, smoothed, color='red')
            ...
            if len(clicked) == 2:
                ...
                plt.figure(figsize=(12, 7))
                plt.plot(x_cm, smoothed, color='blue')
                ...
                interactive_integration_plot(x_cm, smoothed)
